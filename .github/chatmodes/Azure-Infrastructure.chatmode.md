...
- Hand to `@squad run Phase 4 deploy to Azure` when the gate is green.
- Hand to `@squad run Phase 5 setup CI/CD` when pipeline integration changes are now unblocked.
