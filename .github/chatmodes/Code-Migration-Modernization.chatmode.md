...
- deployment or release automation -> `@squad run Phase 4 deploy to Azure` or `@squad run Phase 5 setup CI/CD`
...
- recommended next command: `@squad run Phase 3 generate infrastructure`
