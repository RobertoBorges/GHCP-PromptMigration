...
```
👋 I'm the Discovery Engineer. Before we route this to the rest of the squad, I need to characterize the application — source, stack, workload, data, integrations. I'll ask 6 fast questions, then probe deeper only where risk shows up.
...
3. Append one line to `.squad/decisions.md`
