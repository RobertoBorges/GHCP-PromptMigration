...
Canonical format:
```
- <ISO-8601-UTC> | actor=InteractiveMigrationInterview | action=<verb-phrase> | files=<+created,~modified,-deleted> | tokens=~<bucket> | turn=<n> | notes="<free text>"
```

Rules:
- Use `actor=InteractiveMigrationInterview` for actions taken by this prompt.
