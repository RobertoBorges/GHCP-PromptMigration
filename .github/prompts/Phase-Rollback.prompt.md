...
- Recommend `@squad run Phase 6 post-migration ops` once service is stable again
- Recommend `@squad show migration status` to review the updated status dashboard
