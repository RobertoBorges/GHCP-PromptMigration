...
Canonical format:
```
- <ISO-8601-UTC> | actor=TeamSkillAssessment | action=<verb-phrase> | files=<+created,~modified,-deleted> | tokens=~<bucket> | turn=<n> | notes="<free text>"
```

Rules:
- Use `actor=TeamSkillAssessment` for actions taken by this prompt.
