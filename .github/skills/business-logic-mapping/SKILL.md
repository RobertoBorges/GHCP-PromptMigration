...
description: |
  ...
  **Use when:** Migrating any legacy application (any stack — .NET, Java, Python, Node.js, PHP, Ruby, Go, COBOL, Oracle Forms, etc.) and need to ensure all business logic is preserved.
