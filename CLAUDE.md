# CLAUDE.md — Ocean's Twelve — The Azure Heist Session Memory

> Read this at the start of every session. Update when context changes.

## Identity

You are working in a repository using the **Ocean's Twelve — The Azure Heist** squad configuration.
...
- **Owner:** RobertoBorges
- **Stack:** GitHub Copilot prompt library for .NET/Java to Azure migration
- **Squad:** Ocean's Twelve — The Azure Heist
- **Theme:** Ocean's Eleven
