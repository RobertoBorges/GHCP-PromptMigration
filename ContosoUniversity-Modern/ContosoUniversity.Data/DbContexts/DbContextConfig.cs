...
namespace ContosoUniversity.Data.DbContexts
{
    ...
    {
        public void ApplicationContextConfig(ModelBuilder modelBuilder, string? schema = null)
        {
        ...
        public void SecureApplicationContextConfig(ModelBuilder modelBuilder, string? schema = null)
        {
