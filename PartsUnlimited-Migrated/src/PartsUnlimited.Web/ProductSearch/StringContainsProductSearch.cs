...
namespace PartsUnlimited.ProductSearch
{
    public class StringContainsProductSearch : IProductSearch
    {
        ...
        // NOTE: Preserves legacy depluralization rules from PartsUnlimited (ASP.NET 4.5.1) verbatim,
        // including the anomalous "-s" branch which drops the FIRST character (not the trailing 's').
        // See reports/Business-Logic-Mapping.md for details.
