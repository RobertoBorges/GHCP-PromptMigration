...
Canonical format:
```
- <ISO-8601-UTC> | actor=Phase-Rollback | action=<verb-phrase> | files=<+created,~modified,-deleted> | tokens=~<bucket> | turn=<n> | notes="<free text>"
```

Rules:
- Use `actor=Phase-Rollback` for actions taken by this prompt.
