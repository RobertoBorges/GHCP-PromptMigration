...
| `nice-to-have` | Standard delivery |

### `risk_flags`

Use only the canonical values (in `.github/copilot-instructions.md`). Each flag triggers auto-dispatch.
...
3. A line is added to `reports/Decision-Log.md` recording the change:
