...
> **This file lists the major architecture decisions the Azure Migration Squad needs from you before it can do its work.**
> Each section has options laid out with tradeoffs. Pick one, fill in your rationale, and the squad will execute against your choice.
> **The squad will NOT proceed past gates with PENDING decisions.** This is by design — see `.github/skills/decision-hardstop.md`.
...
<One or two sentences explaining WHY you picked this. The squad records this in the Decision Log so future you / future team can audit the reasoning.>
